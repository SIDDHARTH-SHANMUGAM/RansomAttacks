...
public class UpdateAttacks implements CatalystCronHandler {

	private static final Logger LOGGER = Logger.getLogger(UpdateAttacks.class.getName());
	...
	public CRON_STATUS handleCronExecute(CronRequest request, Context arg1) throws Exception {
		try {
			...
			ZCCache.getInstance().putCacheValue("UpdateAttacks", "Working", 1l);
